    ...
    "properties": {
        ...
        "discovery": {
            ...
            "properties": {
                ...
                "nav_selector": {
                    ...
                    "editor": "selector",
                    "examples": ["a[href*='/zh-cn/products/simatic/']"],
                },
                "name_case": {
                    "type": "string",
                    "required": False,
        ...
        "api": {
            ...
            "properties": {
                "menu": {
                    ...
                    "editor": "text",
                    "examples": ["/api/webportal-dashboard/homepage/menu"],
                },
                "product_detail": {
                    "type": "string",
                    "required": False,
                    ...
                    "editor": "text",
                    "examples": ["/api/webportal-dashboard/products/categoryInfo?categoryId={id}"],
                },
                "product_children": {
                    "type": "string",
                    "required": False,
                    ...
                    "editor": "text",
                    "examples": ["/api/webportal-dashboard/products/getChildren?categoryId={id}"],
                },
                "industry_detail": {
                    "type": "string",
                    "required": False,
                    ...
                    "editor": "text",
                    "examples": ["/api/webportal-dashboard/industry/{id}"],
                },
                "industry_cases": {
                    "type": "string",
                    "required": False,
                    ...
                    "editor": "text",
                    "examples": ["/api/webportal-dashboard/industry/listByCategory?categoryId={id}"],
                },
                "image_download": {
                    "type": "string",
                    "required": False,
                    "default": "",
                    "description": "API endpoint for image download URL rewriting",
                    "editor": "text",
                    "examples": ["/api/sre-service-file/admin/oss/download?fileName={path}&preview=1"],
                },
            },
        },
        ...
        "field_mapping": {
            ...
            "properties": {
                ...
                "item_name": {"type": "string", "description": "API field for item name", "examples": ["name_zhCN"]},
                "item_features": {"type": "string", "description": "API field for short features", "examples": ["shortFeatures_zhCN"]},
                "item_cover": {"type": "string", "description": "API field for cover image URL", "examples": ["coverImage"]},
                "product_html": {"type": "string", "description": "API field for product HTML body", "examples": ["description_zhCN"]},
                "industry_html": {"type": "string", "description": "API field for industry HTML body", "examples": ["content"]},
                "category_name": {"type": "string", "description": "API field for category name", "examples": ["name_zhCN"]},
                "category_children": {"type": "string", "description": "API field for child items", "examples": ["children"]},
                "menu_categories": {"type": "string", "description": "API field for menu product categories", "examples": ["productTypeList"]},
                "menu_industries": {"type": "string", "description": "API field for menu industry list", "examples": ["industryList"]},
